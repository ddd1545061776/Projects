...
<head>
    ...
    <style type="text/css">
    .back{
	background-image: url(${pageContext.request.contextPath}/images/crm.jpg);
 background-repeat: no-repeat; /* 不平埔 */
 
background-attachment: fixed ; /* 居中 */
...
<h1 style="color:yellow">欢迎来到客户管理系统</h1>
    <h3 style="text-align: center;color:yellow;">管理员登录</h3>
